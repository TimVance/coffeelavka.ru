...
if (! empty($result["rows"]))
{
	...
	{
		echo '<div class="news block media">
		...
		if (! empty($row["img"]))
		{
			foreach ($row["img"] as $img)
			{
				...
				echo '<img class="media-object" src="'.$img["src"].'" width="'.$img["width"].'" height="'.$img["height"].'" alt="'.$img["alt"].'" title="'.$img["title"].'">'
				.'</a> ';
			}
		}
		...
		echo '<div class="block-text media-body">';
