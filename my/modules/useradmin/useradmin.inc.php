...
class Useradmin_inc extends Model
{
	...
	public function get($text, $name, $element_id, $table_name, $lang_id = 0, $type = '')
	{
		...
		if (! $this->diafan->_users->useradmin || ! $this->diafan->_users->roles('edit', $module_name))
		{
			return $text;
		}
	...
	{
		if (IS_ADMIN || ! $this->diafan->_users->useradmin || !$this->diafan->_users->roles('edit', "languages"))
		{
			return $value;
		}
