...
echo '<div class="comment panel panel-default"><a name="comment'.$result["id"].'"></a>';
if (! empty($result["name"]))
{
	if(is_array($result["name"]))
	{
		...
		{
			$name = '<div class="panel-heading">'.$name.'</div>';
		}
	}
	else
	{
	...
	echo '<div class="comments_name panel-heading">';
	echo $name.'</div>';
}
if ($result['date'])
{
...
{
	echo '<div class="comments_param panel-heading'.($param["type"] == 'title' ? '_title' : '').'">'.$param["name"];
...
echo '<div class="comments_text"><div class="panel-body">'.$result['text']."</div></div>";
