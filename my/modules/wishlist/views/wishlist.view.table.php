...
//шапка таблицы
echo '<div class="table-responsive"><table class="wishlist table table-bordered">
	<tr>
...
if (! empty($result["rows"]))
{
	foreach ($result["rows"] as $row)
	{
		...
		{
			echo '
			<input type="button" class="btn btn-warning btn-sm btn-buys" value="'.$this->diafan->_('Купить', false).'" good_id="'.$row["id"].'">';
		}
		echo '</td>
		</tr>';
	}
