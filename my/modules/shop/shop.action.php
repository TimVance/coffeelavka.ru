...
class Shop_action extends Action
{
	...
	public function buy()
	{
		...
		$this->result["errors"][0] = $this->diafan->_('В корзине %s %s<br><a class="link_order" href="%s">Оформить</a>', false, $count_good, $measure_unit, BASE_PATH_HREF.$cart_link.'?'.rand(0, 999999));
