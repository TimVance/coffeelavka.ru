	...
	public function get_param($order_id)
	{
		...
		foreach ($params as $param)
		{
			...
			switch($param["type"])
			{
				...
				case "date":
					$param["value"] = $this->diafan->formate_in_date($values[$param["id"]][0]["value"]);
					break;

				case "datetime":
					$param["value"] = $this->diafan->formate_in_datetime($values[$param["id"]][0]["value"]);
					break;
