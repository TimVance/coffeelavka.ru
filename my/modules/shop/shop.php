...
class Shop extends Controller
{
	...
	{
		$attributes = $this->get_attributes($attributes, 'count', 'site_id', 'cat_id', 'images', 'images_variation', 'only_module', 'template');
		...
		$this->model->show_brand($count, $site_ids, $cat_ids, $images, $images_variation);
		$this->model->result();
		$this->model->result["attributes"] = $attributes;
