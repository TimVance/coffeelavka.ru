	...
	public $variables = array (
		'main' => array (
			'name' => array(
				'type' => 'text',
				'name' => 'Название',
				'help' => 'Название поля для импорта, необходимо только для наглядности в списке полей.',
			),
			'type' => array(
				'type' => 'select',
				'name' => 'Тип',
				...
				'select' => array(
					...
					'images' => 'Имена изображений', // имена изображений через «Разделитель данных внутри поля»
					...
					'sort' => 'Номер для сортировки', // товары и категории сортируются по возрастанию
			...
			'params_directory' => array(
				...
				'help' => 'Только для типа «Имена изображений» и «Дополнительная характеристика» с типами «Изображения» и «Файлы».',
				'no_save' => true,
			),
			'params_separator' => array(
				'type' => 'none',
				'name' => 'Разделитель параметров, влияющих на цену, колечества и валюты в пределах одного значения цены/количества',
			...
			'params_second_delimitor' => array(
				...
				'help' => 'Если поле задано, то для типа «Редирект» можно указать через разделитель код редиректа, а для типа «Имена изображений» значения alt и title для изображений.',
				'no_save' => true,
			),
			'hr2' => 'hr',
			'cat_id' => array(
