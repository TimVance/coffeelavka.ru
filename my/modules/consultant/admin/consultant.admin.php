...
class Consultant_admin extends Frame_admin
{
	...
	public function show()
	{
		...
		else
		{
			...
			echo '<p>2. Настройте внешний вид консультанта на сайте <a href="http://www.jivosite.ru?pid=1936" target="_blank">ссылке</a>, используя свой логин и пароль.</p>';
		}
	}
	...
	private function consultant_config_form()
	{
		...
		<p>Идентификатор виджета: <input type="text" name="consultant_id" value="'.str_replace('"', '&quot;', $id).'"></p>
