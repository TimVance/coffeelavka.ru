...
class Service_admin extends Frame_admin
{
	...
	public function show()
	{
		...
		<h2>'.$this->diafan->_('Доступны следующие модули для установки/удаления').':</h2>
		...
		echo '<div class="hr"></div>
			<input type="checkbox" name="example_yes" id="input_example_yes" value="1"> <label for="input_example_yes"><b>'.$this->diafan->_('Заполнить сайт примерами из <a href="http://demo.cms.diafan.ru/" target="_blank">демо-версии</a> (может занять время). Только для устанавливаемых модулей.').'</b></label>
		</div>';
