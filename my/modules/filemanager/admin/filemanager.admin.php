...
class Filemanager_admin extends Frame_admin
{
	...
	public function show_h1()
	{
		...
		<i class="fa fa-warning"></i> '.$this->diafan->_('Внимание! Все изменения необратимы. Для корректной работы DIAFAN.CMS не рекомендуем вручную работать с файлами из папок userfiles и cache.').'</div>';
		echo '</div>';
	}
